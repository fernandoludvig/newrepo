CREATE TYPE public.cse AS ENUM
    ('Client', 'Employee', 'Admin');

ALTER TYPE public.cse
    OWNER TO demo345;
...
(
    ...
    account_type cse NOT NULL DEFAULT 'Client'::cse,
...
-- 4. Modify the GM Hummer description using the REPLACE function
